...
from interpreter import FauxPythonAssemblyError, Interpreter
...
class TestAssemblyToDeltas(unittest.TestCase):
    ...
    def test_instructions_with_arguments(self):
        ...
        self.assertListEqual(interpreter._assembly_to_deltas(assembly), expected_deltas)
    ...
    def test_reciprocity(self):
        ...
        self.assertListEqual(interpreter._deltas_to_assembly(interpreter._assembly_to_deltas(assembly)), assembly)
    ...
    def test_nonexistant_instruction(self):
        ...
        with self.assertRaises(FauxPythonAssemblyError):
            interpreter._assembly_to_deltas(assembly)
